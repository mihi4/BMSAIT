...
//BASIC SETTINGS
  ...
  //#define PRIORITIZE_INPUT     //uncomment this to put a stress on fast er poll of inputs (switches/Buttons) 
    const char ID[]= "BMSAIT_DemoServoPWM";  //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
  ...
  Datenfeld datenfeld[]=
    {
      //Description   ID      DT     OT    target Ref2 Ref3 Ref4 Ref5  IV
       {"RPM",      "0340",   'f',   41,     0,    0,   0,   0,   0,  "0"}     //Example Variable 0 - RPM     //Example Variable 0 - Right Eyebrow Engine Fire
    }; 
