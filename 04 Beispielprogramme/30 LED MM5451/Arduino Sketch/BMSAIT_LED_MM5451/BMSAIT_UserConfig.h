...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_LED_MM5451Demo";  //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
...
//DATA VARIABLES
  ...
  Datenfeld datenfeld[]=
  {
    //Description ID    DT    OT   target  Ref2 Ref3 Ref4 Ref5 RQ  IV
     {"RGear",  "1599", 'b',  13,     0,    1,   0,   0,  0,   "", "False"}     //Example Variable 0 - Right Gear Safe
    ,{"NGear",  "1597", 'b',  13,     0,    2, 0,   0,  0,   "", "False"}     //Example Variable 1 - Nose Gear Safe
    ,{"LGear",  "1598", 'b',  13,     0,    3,   0,   0,  0,   "", "False"}     //Example Variable 2 - Left Gear Safe
    ,{"UGear",  "1571", 'b',  13,     0,    0, 0,   0,  0,   "", "False"}     //Example Variable 3 - Gear handle light
  };      
